...
export class AudioRecorder {
    ...
    async startRecording(): Promise<void> {
        ...
        this.outputChannel.appendLine(`Starting recording to: ${this.audioFilePath}`);
...
`;
        ...
        this.outputChannel.appendLine('Windows recording: Creating placeholder audio file');
    ...
    async stopRecording(): Promise<string> {
        ...
        this.outputChannel.appendLine(`Recording stopped. File saved to: ${this.audioFilePath}`);
